...
class DDIMSampler(object):
    ...
    def sample(self,
        ...
        samples, intermediates = self.ddim_sampling(conditioning, size, ref_img_feature,
                                                    init_image=init_image,      # new
                                                    callback=callback,
                                                    img_callback=img_callback,
                                                    quantize_denoised=quantize_x0,
                                                    mask=mask, x0=x0,
                                                    mask_orig=mask_orig,    # new
    ...
    @torch.no_grad()
    def ddim_sampling(self, cond, shape, ref_img_feature,
                        init_image=None,    # new
    ...
    def encode(self, x0, c, t_enc, use_original_steps=False, return_intermediates=None,
        ...
        print(f"have not found any place uses this function here.")
        import sys;sys.exit(0)
